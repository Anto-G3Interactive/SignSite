...
public class MandatoryCheck extends Initialstep
{
	...
	public void Mandatorycheck() throws InterruptedException, IOException
	{
		...
		String labourvalidation= driver.findElement(By.xpath("//label[text()= 'Machinery Name']/following-sibling::p")).getText();
		String unitvalidation= driver.findElement(By.xpath("//label[text()= 'Units']/following-sibling::p")).getText();
		...
		if((categoryvalidation.contains("Please select a category")) && 
		   (labourvalidation.contains("Machine name is required")) && 
		   ...
		   (pricevalidation.contains("Price must be greater than cost")))
		{
			...
			takescreenshot(driver, "Validation Messages dispalyed");
				...
				driver.findElement(By.xpath("//label[text()= 'Machinery Name']/following-sibling::p")).isDisplayed() &&
				driver.findElement(By.xpath("//label[text()= 'Units']/following-sibling::p")).isDisplayed() &&
				...
				driver.findElement(By.xpath("//label[text()= 'Price']/following-sibling::p")).isDisplayed())
		{
			...
			testcase.log(INFO, "The actual Category field validation is: "+ labourvalidation+ ". And expected is: Machine name is required.");
